...
public class AddExamActivity extends AppCompatActivity implements LoaderCallbacks<Cursor>,View.OnClickListener{
    ...
    private EditText mEditExamDescription;
    DBHelper db;
    Button mSaveButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEditExamName = (EditText) findViewById(R.id.EditexamName);
        mEditExamDescription = (EditText) findViewById(R.id.EditexamDescription);
        mSaveButton = (Button) findViewById(R.id.save_exam_button);
        courseSpinner = (AppCompatSpinner) findViewById(R.id.coursesSpinner);
        //btn dt tm pckr
        btnDatePicker=(Button)findViewById(R.id.btn_exam_due_date);
        btnTimePicker=(Button)findViewById(R.id.btn_exam_due_time);
        txtDate=(EditText)findViewById(R.id.in_exam_due_date);
        txtTime=(EditText)findViewById(R.id.in_exam_due_time);
...
*/
    ...
    public void exam_save(View v)
    {
        ...
        newExam.setExamCourseId(courseList.get(courseSelectedPosition).getCourseId());
        newExam.setExamName  ( mEditExamName.getText().toString());
        newExam.setExamDescription( mEditExamDescription.getText().toString());
        ...
        newExam.setExamTime(time);
        newExam.setExamDate(date);
        db.addNewExam(newExam);
        finish();
    }
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(AddExamActivity.this,
